...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "match_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid chain-id, uppercases", "MATCH_1-1", true, nil,
		},
		{
			"invalid chain-id, mixed cases", "Match_1-1", true, nil,
		},
		{
			"invalid chain-id, special chars", "$&*#!_1-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot start with 0", "match_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "match_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "match_match_699-1", true, nil,
		},
		{
			"invalid epoch, undefined", "match_-", true, nil,
		},
		{
		...
		{
			"long chain-id", "match_" + strings.Repeat("1", 45) + "-1", true, nil,
		},
	}
