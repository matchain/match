...
type EVMBackend interface {
	...
	GetTxByEthHash(txHash common.Hash) (*matchtypes.TxResult, error)
	GetTxByTxIndex(height int64, txIndex uint) (*matchtypes.TxResult, error)
...
type Backend struct {
	...
	indexer             matchtypes.EVMTxIndexer
}
...
func NewBackend(
	...
	chainID, err := matchtypes.ParseChainID(clientCtx.ChainID)
	if err != nil {
		panic(err)
	}
