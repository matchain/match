...
# Initialize chain.
matchd init test --chain-id match_699-2

# Get Genesis
wget https://archive.match.org/mainnet/genesis.json
mv genesis.json ~/.matchd/config/

wget -O ~/.matchd/config/adrbook.json https://snapshot.notional.ventures/match/addrbook.json
...
export EVMOSD_STATESYNC_RPC_SERVERS="https://match-rpc.polkachu.com:443,https://rpc-match-ia.notional.ventures:443"
