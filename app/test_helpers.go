...
import (
	...
	"github.com/matchain/match/cmd/config"
...
// Setup initializes a new Match. A Nop logger is set in Match.
func Setup(
	isCheckTx bool,
	...
	app := NewMatch(log.NewNopLogger(), db, nil, true, map[int64]bool{}, DefaultNodeHome, 5, encoding.MakeConfig(ModuleBasics), simapp.EmptyAppOptions{})
	if !isCheckTx {
...
func GenesisStateWithValSet(app *Match, genesisState simapp.GenesisState,
